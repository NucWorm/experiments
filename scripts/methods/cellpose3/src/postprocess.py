#!/usr/bin/env python3
"""
Cellpose3 post-processing script for NucWorm benchmark.

This script extracts centroid coordinates from Cellpose3 instance segmentation masks
...
def main():
    parser = argparse.ArgumentParser(description="Cellpose3 post-processing for NucWorm benchmark")
    ...
    logger.info("Cellpose3 post-processing completed!")
